    ...
    <main class="container mt-4">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="d-flex justify-content-between mb-4">
                ...
                <?php else: ?>
                <h4>Pagos de <?php echo $user['nombre'] ?></h4>
                <?php endif; ?>

                <?php else: ?>
                <div>
                    <h4>¡Hola <?php echo $_SESSION['nombres'] ?>!</h4>
                    <p>Este es el historial de tus pagos</p>
                </div>
                <?php endif; ?>
                <div>
                    <?php if ( $current_id ) : ?>
                    <a href="/payments/add/<?php echo $current_id ?>" class="btn btn-sm btn-success">Nuevo pago</a>
                    <?php endif; ?>
                </div>
            </div>
